...
final class TextEditorComponentViewController: UIViewController {
...
// MARK: - Builder
extension TextEditorComponentViewController {

    static func build() -> TextEditorComponentViewController {
        let viewModel = TextEditorComponentUIViewModel(theme: SparkThemePublisher.shared.theme)
        let viewController = TextEditorComponentViewController(viewModel: viewModel)
