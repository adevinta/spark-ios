//
//  ProgressBarIndeterminateComponentUIViewController.swift
//  Spark
//
...
final class ProgressBarIndeterminateComponentUIViewController: UIViewController {
    ...
    let componentView: ProgressBarIndeterminateComponentUIView
    ...
    init(viewModel: ProgressBarIndeterminateComponentUIViewModel) {
        ...
        self.componentView = ProgressBarIndeterminateComponentUIView(viewModel: viewModel)
