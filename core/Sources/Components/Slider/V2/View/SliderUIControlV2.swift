...
public final class SliderUIControlV2<V>: UIControl where V: BinaryFloatingPoint, V.Stride: BinaryFloatingPoint {

    private let viewModel: SingleSliderViewModelV2<V>
    ...
    init(viewModel: SingleSliderViewModelV2<V>) {
