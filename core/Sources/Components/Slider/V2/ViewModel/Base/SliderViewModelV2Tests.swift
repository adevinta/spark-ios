...
final class SliderViewModelTestsV2: SliderViewModelV2WithMocksTests {

    override func setUp() {
        super.setUp()
        self.viewModel = SliderViewModelV2(
            theme: self.theme,
            shape: self.shape,
            intent: self.intent,
