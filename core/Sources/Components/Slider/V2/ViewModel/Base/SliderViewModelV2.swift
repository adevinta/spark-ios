...
class SliderViewModelV2<V> where V: BinaryFloatingPoint, V.Stride: BinaryFloatingPoint  {
    ...
    private let getClosestValueUseCase: SliderGetClosestValueUseCasableV2
    ...
    required init(theme: Theme,
                  ...
                  getClosestValueUseCase: SliderGetClosestValueUseCasableV2 = SliderGetClosestValueUseCaseV2()) {
        self.theme = theme
        self.shape = shape
        self.intent = intent
