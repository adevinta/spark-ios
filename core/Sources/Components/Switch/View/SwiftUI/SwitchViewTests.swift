...
final class SwitchViewTests: SwiftUIComponentTestCase {
    ...
    func test_swiftUI_switch_colors() throws {
        let suts = try SwitchSutTests.allColorsCases(isSwiftUIComponent: true)
        self.test(suts: suts)
    }

    func test_swiftUI_switch_contens() throws {
        let suts = try SwitchSutTests.allContentsCases(isSwiftUIComponent: true)
        self.test(suts: suts)
    }

    func test_swiftUI_switch_positions() throws {
        let suts = try SwitchSutTests.allPositionsCases(isSwiftUIComponent: true)
        self.test(suts: suts)
    }
}
...
private extension SwitchViewTests {
