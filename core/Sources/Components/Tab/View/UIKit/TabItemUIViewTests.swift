...
final class TabItemUIViewTests: TestCase {
    ...
    func test_content_changed_not_published_when_no_badge_change() {
        // Given
        let badge = UIView()
    ...
    func test_content_changed_published_badge_change() {
        // Given
        self.sut.badge = UIView()
        let expect = expectation(description: "Content should be changed")
    ...
    func test_change_icon_triggers_content_change() {
        // Given
        let expect = expectation(description: "Content should be changed")
        ...
        // When
        self.sut.icon = .init(systemName: "pencil")

        // Then
        waitForExpectations(timeout: 1)
    }

    func test_change_text_triggers_content_change() {
        // Given
        let expect = expectation(description: "Content should be changed")
