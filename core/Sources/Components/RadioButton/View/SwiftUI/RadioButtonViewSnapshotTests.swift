//
//  RadioButtonViewSnapshotTests.swift
//  SparkCoreTests
//
...
final class RadioButtonViewSnapshotTests: SwiftUIComponentSnapshotTestCase {
...
private extension RadioButtonGroupState {
    func label(isSelected: Bool) -> String {
        ...
        case .accent: return "Accent / " + selected
        case .basic: return "Basic / " + selected
        }
    }
}
