...
final class TextEditorComponentUIViewModel: ComponentUIViewModel {
    ...
    lazy var isUserInteractionEnabledEnabledConfigurationItemViewModel: ComponentsConfigurationItemUIViewModel = {
        return .init(
            name: "is User Interaction Enabled",
            type: .checkbox(title: "", isOn: self.isUserInteractionEnabled),
    ...
    override func configurationItemsViewModel() -> [ComponentsConfigurationItemUIViewModel] {
        return [
            ...
            self.isUserInteractionEnabledEnabledConfigurationItemViewModel,
...
extension TextEditorComponentUIViewModel {
    ...
    @objc func enabledChanged(_ isSelected: Any?) {
        self.isUserInteractionEnabled = isTrue(isSelected)
    }
